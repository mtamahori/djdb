...
async function seed() {
  ...
  const users = await Promise.each([
    ...
    {username: 'meri', password: '123'},
    {username: 'miles', password: '123'},
    {username: 'maeve', password: '123'},
    {username: 'jason', password: '123'},
    {username: 'jake', password: '123'},
    {username: 'ray', password: '123'},
    {username: 'tom', password: '123'},
    {username: 'paddy', password: '123'},
    {username: 'merrick', password: '123'},
    {username: 'alicia', password: '123'},
    {username: 'sam', password: '123'},

    {username: 'smartbar', password: '123'},
    {username: 'dannys', password: '123'},
    {username: 'punchhouse', password: '123'},
    {username: 'whistler', password: '123'},
    {username: 'boozebox', password: '123'},
    {username: 'hideout', password: '123'},
    {username: 'arboreal', password: '123'},
    {username: 'underground', password: '123'},
  ], (user) => {
