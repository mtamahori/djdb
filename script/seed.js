...
async function seed() {
  ...
  const users = await Promise.each([
    {username: 'max@email.com', password: '123'},
    {username: 'meri@email.com', password: '123'},
    {username: 'miles@email.com', password: '123'},
    {username: 'maeve@email.com', password: '123'},
    {username: 'jason@email.com', password: '123'},
    {username: 'jake@email.com', password: '123'},
    {username: 'ray@email.com', password: '123'},
    {username: 'tom@email.com', password: '123'},
    {username: 'paddy@email.com', password: '123'},
    {username: 'merrick@email.com', password: '123'},
    {username: 'alicia@email.com', password: '123'},
    {username: 'sam@email.com', password: '123'},

    {username: 'smartbar@email.com', password: '123'},
    {username: 'dannys@email.com', password: '123'},
    {username: 'punchhouse@email.com', password: '123'},
    {username: 'whistler@email.com', password: '123'},
    {username: 'boozebox@email.com', password: '123'},
    {username: 'hideout@email.com', password: '123'},
    {username: 'arboreal@email.com', password: '123'},
    {username: 'underground@email.com', password: '123'},
  ], (user) => {
